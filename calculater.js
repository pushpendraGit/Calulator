...
function printOutput(num)
{
    if(num=="")
    {
        ...
        document.getElementById('output-value').innerText=getFormetedNumber(num);
    }
...
function getFormetedNumber(num)
{
